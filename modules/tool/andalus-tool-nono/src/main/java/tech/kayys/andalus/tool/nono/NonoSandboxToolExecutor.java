...
import tech.kayys.andalus.tool.ToolContext;
import tech.kayys.andalus.tool.ToolExecutor;
 ...
 *
 * <p>The main Andalus platform JVM is <b>never sandboxed</b>.  Sandbox policy
...
public class NonoSandboxToolExecutor implements ToolExecutor {
    ...
    private ToolResult buildToolResult(tech.kayys.andalus.spi.sandbox.SandboxExecutionResult res) {
        ...
        return new ToolResult() {
            ...
            @Override public tech.kayys.andalus.identity.ResourceId id() {
                return tech.kayys.andalus.identity.ResourceId.from(
                    tech.kayys.andalus.extension.Id.random(),
                    new tech.kayys.andalus.resource.ResourceType.Tool()
                );
            }
            @Override public tech.kayys.andalus.resource.ResourceType type() {
                return new tech.kayys.andalus.resource.ResourceType.Tool();
            }
            @Override public tech.kayys.andalus.extension.Metadata metadata() {
                return tech.kayys.andalus.extension.Metadata.builder()
                    .name("NonoSandboxResult")
                    .version(tech.kayys.andalus.extension.Version.parse("1.0.0"))
