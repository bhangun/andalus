package tech.kayys.andalus.tool.rest;
...
import tech.kayys.andalus.tool.executor.AbstractToolExecutor;
import tech.kayys.andalus.tool.node.ToolNodeTypes;
...
public class RESTToolExecutor extends AbstractToolExecutor {
    ...
    void init() {
        this.webClient = WebClient.create(vertx, new WebClientOptions()
                .setUserAgent("Andalus-REST-Executor/1.0.0")
