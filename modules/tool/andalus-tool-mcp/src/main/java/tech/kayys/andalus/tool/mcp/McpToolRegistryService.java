...
public class McpToolRegistryService {
    ...
    private Uni<List<tech.kayys.andalus.tool.entity.McpTool>> filteredRegistryTools(
            String requestId,
    ...
    private Uni<List<tech.kayys.andalus.tool.entity.McpTool>> listTenantTools(String requestId, String namespace) {
