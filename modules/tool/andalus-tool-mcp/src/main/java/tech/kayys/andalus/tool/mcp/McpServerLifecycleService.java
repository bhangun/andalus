...
public class McpServerLifecycleService {
    ...
    private Uni<LifecycleToolChanges> updateMatchingTools(
        ...
        for (tech.kayys.andalus.tool.entity.McpTool tool : tools) {
    ...
    private boolean shouldUpdateTool(tech.kayys.andalus.tool.entity.McpTool tool, boolean enabled) {
        return enabled ? McpToolLifecycle.isServerDisabled(tool) && !McpToolLifecycle.isStale(tool) : tool.isEnabled();
    }

    private void applyToolState(tech.kayys.andalus.tool.entity.McpTool tool, boolean enabled) {
    ...
    private void retireTool(tech.kayys.andalus.tool.entity.McpTool tool) {
    ...
    private boolean belongsToServer(tech.kayys.andalus.tool.entity.McpTool tool, String serverName) {
    ...
    private final class LifecycleImpactAccumulator {
        ...
        private void add(tech.kayys.andalus.tool.entity.McpTool tool) {
