...
public class McpToolCallHistoryPruneScheduler {
    ...
    @ConfigProperty(name = "andalus.mcp.tool-call-history.scheduled-prune.enabled", defaultValue = "true")
    boolean enabled = true;

    @Scheduled(
            every = "{andalus.mcp.tool-call-history.scheduled-prune.interval:5m}",
            delayed = "{andalus.mcp.tool-call-history.scheduled-prune.delayed:45s}",
