...
public class McpServerActionExecutionHistoryPruneScheduler {
    ...
    @ConfigProperty(name = "andalus.mcp.action-history.scheduled-prune.enabled", defaultValue = "true")
    boolean enabled = true;

    @Scheduled(
            every = "{andalus.mcp.action-history.scheduled-prune.interval:5m}",
            delayed = "{andalus.mcp.action-history.scheduled-prune.delayed:50s}",
