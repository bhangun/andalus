...
final class McpToolRegistryMapper {
    ...
    static McpToolRegistryEntry toRegistryEntry(tech.kayys.andalus.tool.entity.McpTool tool) {
    ...
    private static Map<String, Object> defaultMcpContext(tech.kayys.andalus.tool.entity.McpTool tool) {
