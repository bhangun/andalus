package tech.kayys.andalus.tool.os;
 ...
 *
 * <p>Set {@code -Dandalus.web_search.provider=wikipedia} (default) or {@code duckduckgo}.
 */
public final class WebSearchTool implements Tool {
    ...
    public ToolResult execute(Map<String, Object> params, ToolContext context) {
        ...
        String providerName = System.getProperty("andalus.web_search.provider", "duckduckgo").toLowerCase();
    ...
    private static String fetchTextWithSslFallback(String urlStr, String acceptHeader) throws Exception {
        if (Boolean.getBoolean("andalus.web_search.disable_ssl_verify") && urlStr.startsWith("https://")) {
    ...
    private static String fetchRaw(String urlStr, String acceptHeader, boolean skipSsl) throws Exception {
        ...
        conn.setRequestProperty("User-Agent",
                "Mozilla/5.0 (compatible; Andalus-AI-Agent/1.0)");
