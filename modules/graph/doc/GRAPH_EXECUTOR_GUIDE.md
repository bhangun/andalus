...
```
andalus/executors/graph/
├── pom.xml                              # Parent POM
├── andalus-graph-core/                   # Core interfaces and models
│   ├── pom.xml
│   └── src/main/java/tech/kayys/andalus/graph/
...
├── andalus-graph-inmemory/               # In-memory implementation
│   ├── pom.xml
│   └── src/main/java/tech/kayys/andalus/graph/inmemory/
│       └── InMemoryGraphStore.java      # In-memory store
├── andalus-graph-neo4j/                  # Neo4j implementation
│   ├── pom.xml
│   └── src/main/java/tech/kayys/andalus/graph/neo4j/
│       └── Neo4jGraphStore.java         # Neo4j store
└── andalus-graph-runtime/                # Runtime executors
    ├── pom.xml
    └── src/main/java/tech/kayys/andalus/graph/runtime/
...
andalus.graph.store.type=inmemory
andalus.graph.store.inmemory.enabled=true
...
andalus.graph.store.neo4j.database=neo4j
```
...
## Integration with Andalus Agents

The graph executor integrates with Andalus agents for:
