...
with open('src/main/java/tech/kayys/andalus/provider/gollek/GollekInferenceProvider.java', 'r') as f:
    content = f.read()
...
with open('src/main/java/tech/kayys/andalus/provider/gollek/GollekInferenceProvider.java', 'w') as f:
    f.write(content)
