...
```properties
# RAG Configuration
andalus.rag.enabled=true
andalus.rag.retrieval.top-k=5
andalus.rag.retrieval.threshold=0.7
andalus.rag.generation.model=llama-3.2-3b
...
andalus.memory.semantic.enabled=true
andalus.memory.semantic.vector-index=semantic_memories

# Integration Settings
andalus.rag.memory.integration.enabled=true
andalus.rag.memory.weight=0.5  # Balance between memory and documents
```
