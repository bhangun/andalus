# Andalus PostgreSQL Vector Store

The Andalus PostgreSQL Vector Store provides a production-ready vector storage implementation using PostgreSQL with the pgvector extension.

## Overview

This module implements the Andalus VectorStore interface using PostgreSQL as the backend, leveraging the pgvector extension for efficient vector similarity search operations.
...
andalus.vector.pgvector.dimension=1536

# Index type: hnsw or ivfflat (default: hnsw)
andalus.vector.pgvector.index.type=hnsw

# PostgreSQL connection settings
quarkus.datasource.reactive.url=postgresql://localhost:5432/andalus
...
```sql
CREATE TABLE andalus_vector_entries (
