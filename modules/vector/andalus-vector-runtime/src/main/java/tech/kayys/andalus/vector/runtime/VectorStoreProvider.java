...
public class VectorStoreProvider {
    ...
    @ConfigProperty(name = "andalus.vector.store.type", defaultValue = "faiss")
    ...
    @ConfigProperty(name = "andalus.vector.faiss.dimension", defaultValue = "768")
    int faissDimension;

    @ConfigProperty(name = "andalus.vector.faiss.index.type", defaultValue = "Flat")
    String faissIndexType;

    @ConfigProperty(name = "andalus.vector.faiss.index.path", defaultValue = "")
