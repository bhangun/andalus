...
import tech.kayys.andalus.schema.catalog.BuiltinSchemaCatalog;
import tech.kayys.andalus.schema.vector.VectorSearchConfig;
import tech.kayys.andalus.schema.vector.VectorUpsertConfig;

import java.util.List;
import java.util.Map;

/**
 * Exposes the Vector Executor capabilities (Search, Upsert) as Andalus nodes.
 */
public class VectorNodeProvider implements NodeProvider {

    @Override
    public String id() {
        return "andalus-vector-runtime";
    }
