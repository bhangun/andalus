package tech.kayys.andalus.vector.faiss;
 ...
 * <p>
 * Loads {@code libfaiss_c} from {@code ~/.andalus/lib/} via JDK 25
...
public final class FaissNative {
    ...
    static {
        ...
        Path libDir = Path.of(System.getProperty("user.home"), ".andalus", "lib");
        String libPath = System.getProperty("andalus.faiss.lib.path",
