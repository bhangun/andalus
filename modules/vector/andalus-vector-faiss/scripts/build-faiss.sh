#!/usr/bin/env bash
# Build FAISS C API shared library for Andalus FFM integration.
# Source is placed in ~/.andalus/vendor/faiss
# Output library goes to ~/.andalus/lib/
#
# Usage:
...
VENDOR_DIR="${HOME}/.andalus/vendor"
FAISS_DIR="${VENDOR_DIR}/faiss"
LIB_DIR="${HOME}/.andalus/lib"
...
echo "=== Andalus FAISS Native Build ==="
