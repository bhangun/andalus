...
public class GollekManager {
    ...
    public static void ensureGollekRunning() {
        boolean nonInteractive = System.console() == null || 
                                 Boolean.getBoolean("andalus.cli.nonInteractive") || 
                                 System.getenv("ANDALUS_NON_INTERACTIVE") != null;
        ...
        if (!isInstalled()) {
            ...
            System.out.print("Gollek are not running, did you want andalus to run gollek? (Y/n): ");
            String answer = scanner.nextLine().trim().toLowerCase();
