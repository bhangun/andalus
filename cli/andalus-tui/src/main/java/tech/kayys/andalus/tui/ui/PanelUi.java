...
import tech.kayys.andalus.tools.spi.*;
...
public final class PanelUi {
    ...
    public PanelUi(Config config, AndalusAgent agent) {
        this.config = config;
        this.agent = agent;
            }
    ...
    private void submit() {
        ...
        AndalusAgentListener listener = new PanelListener();
    ...
    private final class PanelListener implements AndalusAgentListener {
