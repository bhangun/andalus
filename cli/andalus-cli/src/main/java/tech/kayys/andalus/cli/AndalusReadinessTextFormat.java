...
import tech.kayys.andalus.readiness.AndalusReadinessReport;

import java.util.List;
import java.util.Map;

/**
 * Plain-text renderer for aggregate Andalus readiness reports.
 */
final class AndalusReadinessTextFormat {

    private static final String NL = System.lineSeparator();

    private AndalusReadinessTextFormat() {
    }

    static String text(AndalusReadinessReport readiness) {
        StringBuilder output = new StringBuilder("Andalus readiness").append(NL);
