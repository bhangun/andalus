 ...
 */
public record AndalusCliOutputTarget(String path, boolean force) {
    ...
    public static AndalusCliOutputTarget of(String path, boolean force) {
        ...
        return new AndalusCliOutputTarget(path, force);
    }
