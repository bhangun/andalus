 ...
 * by {@code AndalusCodeCommand} before handing the agent to {@code ReplUi}.
 */
public final class AndalusInternalAgentTools {

    private AndalusInternalAgentTools() {}

    // ─────────────────────────────────────────────────────────────────────────
    // Shared mutable context injected by AndalusCodeCommand
    // ─────────────────────────────────────────────────────────────────────────
    ...
    public static class ProjectListTool implements Tool {
        ...
        @Override public String description() { return "List all known Andalus projects with their IDs, names, and directories."; }
        @Override public Map<String, Object> inputSchema() {
            return Map.of("type", "object", "properties", Map.of(), "required", List.of());
        }
        @Override public ToolResult execute(Map<String, Object> params, ToolContext context) {
        ...
        @Override public ToolResult execute(Map<String, Object> params, ToolContext context) {
            ...
            try {
                ...
                try {
                    ...
                    java.nio.file.Path cfg = Path.of(System.getProperty("user.home"), ".andalus", "current_project.txt");
    ...
    public static class StatusTool implements Tool {
        ...
        @Override public String description() { return "Return the current Andalus platform status: active model, provider, project, session, memory, workspace."; }
        @Override public Map<String, Object> inputSchema() {
            return Map.of("type", "object", "properties", Map.of(), "required", List.of());
        }
        @Override public ToolResult execute(Map<String, Object> params, ToolContext context) {
    ...
    public static class InfoTool implements Tool {
        ...
        @Override public String description() { return "Return system/runtime information: Java version, OS, available memory, and Andalus configuration."; }
        @Override public Map<String, Object> inputSchema() {
            return Map.of("type", "object", "properties", Map.of(), "required", List.of());
        }
        @Override public ToolResult execute(Map<String, Object> params, ToolContext context) {
