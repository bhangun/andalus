    ...
    private void handleMetaCommand(String line, ConversationSession session,
        ...
        switch (cmd) {
            ...
            case "/provider", "/providers" -> {
                ...
                tech.kayys.andalus.inference.InferenceService.getInstance().reloadProviders();
                tech.kayys.andalus.provider.AndalusPluginManager.getInstance().getLoadedProviders()
