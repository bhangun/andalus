...
import tech.kayys.andalus.knowledge.graph.DefaultKnowledgeGraphProjectionService;
import tech.kayys.andalus.knowledge.graph.KnowledgeGraphProjectionService;
import tech.kayys.andalus.knowledge.graph.KnowledgeGraphQuery;
import tech.kayys.andalus.knowledge.graph.KnowledgeGraphView;
 ...
 *
 * <p>Implements {@code KnowledgeGraphService} from {@code andalus_api.proto}.
...
public class KnowledgeGraphGrpcService extends KnowledgeGraphServiceGrpc.KnowledgeGraphServiceImplBase {
    ...
    public void getLineageGraph(KnowledgeLineageGraphRequest request,
        ...
        try {
            ...
            for (tech.kayys.andalus.knowledge.graph.KnowledgeGraphEdge edge : view.edges()) {
    ...
    private KnowledgeGraphResponse toResponse(KnowledgeGraphView view) {
        ...
        for (tech.kayys.andalus.knowledge.graph.KnowledgeGraphNode n : view.nodes()) {
        ...
        for (tech.kayys.andalus.knowledge.graph.KnowledgeGraphEdge e : view.edges()) {
