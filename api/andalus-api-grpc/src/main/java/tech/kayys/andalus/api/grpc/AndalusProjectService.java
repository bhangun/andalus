...
// protoc compilation. Implementations bridge to Andalus's ProjectStore
// in andalus-project.

public class AndalusProjectService extends ProjectServiceGrpc.ProjectServiceImplBase {
    private static final Logger log = LoggerFactory.getLogger(AndalusProjectService.class);
    private final ProjectStore store;

    public AndalusProjectService() {
        super();
        ProjectStore tmp = null;
        try {
            tmp = new ProjectStore(null);
        } catch (Exception e) {
