package tech.kayys.andalus.hitl.resource;
...
import tech.kayys.andalus.hitl.dto.*;
import tech.kayys.andalus.hitl.service.EscalationService;
import tech.kayys.andalus.hitl.service.HumanTaskService;
import tech.kayys.andalus.hitl.service.TaskStatistics;
import tech.kayys.andalus.hitl.domain.*;
import tech.kayys.andalus.hitl.repository.*;
    ...
    public Uni<RestResponse<TaskDto>> claimTask(@PathParam("taskId") String taskId) {
        ...
        return taskService.getTask(HumanTaskId.of(taskId))
            ...
            .onFailure().transform(error ->
                new AndalusException(ErrorCode.VALIDATION_FAILED, error.getMessage(), error));
    }
