package tech.kayys.andalus.runner;
...
import tech.kayys.andalus.execution.AgentExecution;
import tech.kayys.andalus.execution.AgentExecutionService;
import tech.kayys.andalus.execution.ExecutionBudget;
import tech.kayys.andalus.execution.RuntimeBehavior;
import tech.kayys.andalus.extension.Metadata;

/**
 * Andalus Standalone Agent Runner — headless CI/CD entry point for Andalus agents.
 *
 ...
 *   andalus-runner --model gemini-pro --behavior THOROUGH "Analyse code quality"
 *   andalus-runner --no-json "What is 2 + 2"
 * </pre>
 */
@Command(
    name = "andalus-runner",
    mixinStandardHelpOptions = true,
    description = "Standalone CI/CD runner for Andalus agents"
)
public class AndalusAgentRunner implements Runnable {
    ...
    public void run() {
        try {
            ...
            System.err.println("[andalus-runner] Fatal error: " + e.getMessage());
