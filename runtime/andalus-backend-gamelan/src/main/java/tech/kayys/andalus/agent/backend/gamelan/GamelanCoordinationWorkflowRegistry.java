...
import tech.kayys.andalus.coordination.DefaultWorkflowDefinitionCanonicalizer;
import tech.kayys.andalus.coordination.WorkflowDefinitionCanonicalizer;
...
public class GamelanCoordinationWorkflowRegistry implements CoordinationWorkflowDefinitionRegistry {
    ...
    public static final String FINGERPRINT_LABEL = ".coordination.fingerprint";
        ...
        List<NodeDefinition> nodeDefinitions = def.nodes().stream()
                .map(node -> {
                    ...
                    return new NodeDefinition(
                            ...
                            node.id(),
                            NodeType.TASK,
                            AndalusAgentNodeExecutor.EXECUTOR_TYPE,
                            config,
                            dependsOn,
                            List.of(),
                            RetryPolicy.none(),
