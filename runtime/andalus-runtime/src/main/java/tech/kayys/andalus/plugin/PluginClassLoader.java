 ...
 * JAR file(s) with proper isolation from the core Andalus runtime. It follows
 ...
 *   <li>Core Andalus classes (io.andalus.core.*) are loaded from parent</li>
 ...
 * </ul>
 * 
 * @see io.andalus.manifest.Manifest
 * @see io.andalus.extension.Extension
 * @see io.andalus.plugin.PluginManager
 */
public class PluginClassLoader extends URLClassLoader {
    ...
    protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
        ...
        // Core Andalus classes should be loaded from parent
        if (isCoreClass(name)) {
            c = getParent().loadClass(name);
            loadedClassCache.put(name, c);
            if (resolve) {
    ...
    /**
     * Checks if a class is a core Andalus class that must be loaded from the parent.
     *
     * @param name The class name
