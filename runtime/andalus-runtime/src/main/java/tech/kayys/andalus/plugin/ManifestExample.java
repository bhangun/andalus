...
public class ManifestExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Manifest manifest = Manifest.builder()
            .id("andalus-ai-plugin")
            .name("Andalus AI Plugin")
            .version("2.0.0")
            .description("AI capabilities for Andalus")
            .mainClass("io.andalus.plugin.AIPlugin")
            .author("Andalus Team")
            .author("Contributor")
            .license("Apache-2.0")
            .repository("https://github.com/andalus/ai-plugin")
            .documentation("https://docs.andalus.io/ai-plugin")
            
            // Dependencies
            .dependency("andalus-core", Version.VERSION_1_0_0)
            .dependency("andalus-database", Version.parse("1.5.0"))
            .dependency(Dependency.of("andalus-messaging", Version.parse("1.0.0"), "provided"))
            
            // Provided capabilities
            .provides(ProvidedCapability.of("llm-provider", "Andalus LLM Provider", "model"))
            .provides(new ProvidedCapability(
                "embedding-provider",
                "Andalus Embedding Provider",
                Version.parse("2.0.0"),
                "embedding",
            ...
            .metadata("compatibleWith", "Andalus 1.0+")
        ...
        Optional<Manifest> found = registry.getByName("Andalus AI Plugin");
        if (found.isPresent()) {
        ...
        Manifest anotherManifest = Manifest.builder()
            ...
            .name("Another Plugin")
            .version("1.0.0")
            .description("Another plugin for Andalus")
            .author("Community")
            .license("MIT")
