package tech.kayys.andalus.rag.runtime.embedder;

import tech.kayys.andalus.rag.spi.RagEmbedder;

import java.util.List;

/**
 * Placeholder embedder that returns zero-vectors.
 * Replace with a real embedding model (e.g. via andalus-embedding) in production.
 */
