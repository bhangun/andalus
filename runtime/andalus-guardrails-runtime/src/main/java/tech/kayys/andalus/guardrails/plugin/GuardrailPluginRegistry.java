package tech.kayys.andalus.guardrails.plugin;
...
public class GuardrailPluginRegistry {
    ...
    @Inject
    Instance<tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin> detectorPlugins;

    private volatile List<tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin> cachedPreExecutionDetectors;
    private volatile List<tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin> cachedPostExecutionDetectors;

    /**
     * Get all registered guardrail detector plugins.
     */
    public List<tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin> getAllDetectorPlugins() {
        List<tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin> plugins = new ArrayList<>();

        if (detectorPlugins.isResolvable()) {
            for (tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin plugin : detectorPlugins) {
                plugins.add(plugin);
            }
        }
     ...
     */
    public List<tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin> getPreExecutionDetectors() {
     ...
     */
    public List<tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin> getPostExecutionDetectors() {
     ...
     */
    public Optional<tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin> getDetectorById(String id) {
     ...
     */
    public List<tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin> getDetectorsByCategory(
            String category) {
        return getAllDetectorPlugins().stream()
    ...
    public Uni<List<DetectionResult>> runDetectorsForPhase(
        ...
        List<tech.kayys.andalus.guardrails.plugin.api.GuardrailDetectorPlugin> detectors = switch (phase) {
