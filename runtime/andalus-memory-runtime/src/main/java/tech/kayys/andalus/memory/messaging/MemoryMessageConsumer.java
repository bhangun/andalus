package tech.kayys.andalus.memory.messaging;
...
public class MemoryMessageConsumer {
    ...
    private Uni<Void> publishMemoryContext(String requestId, tech.kayys.andalus.memory.model.MemoryContext context) {
