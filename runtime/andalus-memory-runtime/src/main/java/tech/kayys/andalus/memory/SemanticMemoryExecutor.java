...
public class SemanticMemoryExecutor extends AbstractMemoryExecutor {
     ...
     */
    @ConfigProperty(name = "andalus.memory.semantic.default.category", defaultValue = "general")
    String defaultCategory;

    /**
     * Enable concept linking
     */
    @ConfigProperty(name = "andalus.memory.semantic.concept.linking", defaultValue = "true")
    boolean enableConceptLinking;

    /**
     * Default search limit
     */
    @ConfigProperty(name = "andalus.memory.semantic.search.limit", defaultValue = "15")
