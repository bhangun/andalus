package tech.kayys.andalus.memory.executor;
...
public class UnifiedMemoryExecutor extends AbstractMemoryExecutor {
    ...
    @ConfigProperty(name = "andalus.memory.semantic.enabled", defaultValue = "true")
    boolean semanticEnabled;

    @ConfigProperty(name = "andalus.memory.episodic.enabled", defaultValue = "true")
    boolean episodicEnabled;

    @ConfigProperty(name = "andalus.memory.working.enabled", defaultValue = "true")
    boolean workingEnabled;

    @ConfigProperty(name = "andalus.memory.short.enabled", defaultValue = "true")
    boolean shortTermEnabled;

    @ConfigProperty(name = "andalus.memory.longterm.enabled", defaultValue = "true")
    ...
    @Override
    protected tech.kayys.andalus.memory.spi.MemoryEntry createMemoryEntry(String content, Map<String, Object> context) {
        tech.kayys.andalus.memory.spi.MemoryEntry entry = super.createMemoryEntry(content, context);
