...
public class EpisodicMemoryExecutor extends AbstractMemoryExecutor {
     ...
     */
    @ConfigProperty(name = ".memory.episodic.default.event.type", defaultValue = "general")
    String defaultEventType;

    /**
     * Enable temporal ordering
     */
    @ConfigProperty(name = ".memory.episodic.temporal.ordering", defaultValue = "true")
    boolean enableTemporalOrdering;

    /**
     * Default search limit
     */
    @ConfigProperty(name = ".memory.episodic.search.limit", defaultValue = "20")
    int defaultSearchLimit;

    /**
     * Time window for related events (in hours)
     */
    @ConfigProperty(name = ".memory.episodic.related.time.window.hours", defaultValue = "24")
