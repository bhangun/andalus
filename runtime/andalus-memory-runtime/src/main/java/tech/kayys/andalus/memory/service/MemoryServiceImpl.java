...
import tech.kayys.andalus.memory.entity.*;
...
public class MemoryServiceImpl implements MemoryService {
    ...
    @Inject
    tech.kayys.andalus.embedding.EmbeddingService embeddingService;
    ...
    public Uni<List<ConversationMemory>> findSimilarMemories(String sessionId, String query, int limit) {
        ...
        return embeddingService.embedOne(query)
            .onItem().transformToUni(queryVector -> {
                ...
                // In a real scenario, tech.kayys.andalus.memory.service.VectorMemoryStore would be used.
