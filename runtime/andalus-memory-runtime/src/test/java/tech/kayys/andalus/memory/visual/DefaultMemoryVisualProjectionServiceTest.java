package tech.kayys.andalus.memory.visual;

import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import tech.kayys.andalus.memory.context.*;
...
import tech.kayys.andalus.memory.service.InMemoryVectorStore;
...
class DefaultMemoryVisualProjectionServiceTest {
    ...
    void testSemanticGraphProjection() {
        SemanticMemory semantic = new SemanticMemory(
                ...
                List.of(new Fact("Andalus", "orchestrates", "Agents", 0.95, Instant.now())),
                Map.of("Quarkus", 0.9),
                Instant.now()
        );
        ...
        assertThat(graph.nodes()).anyMatch(n -> n.id().equals("Andalus"));
    }
