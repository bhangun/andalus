package tech.kayys.andalus.agent.integration.gamelan.graph;
...
import tech.kayys.andalus.agent.integration.gamelan.AgentGamelanService;
import tech.kayys.andalus.graph.GraphStore;
import tech.kayys.andalus.graph.Node;
import tech.kayys.andalus.graph.Relationship;
...
public class WorkflowGraphService {
    ...
    @LoggerName("tech.kayys.andalus.agent.core.gamelan.graph")
    Logger logger;
