...
import tech.kayys.andalus.knowledge.decision.KnowledgeDecisionOutcome;
import tech.kayys.andalus.knowledge.decision.KnowledgeDecisionRecorder;
import tech.kayys.andalus.knowledge.decision.KnowledgeDecisionTrace;
import tech.kayys.andalus.knowledge.integrity.DefaultKnowledgeIntegrityFingerprintProvider;
import tech.kayys.andalus.knowledge.integrity.DefaultKnowledgeSnapshotIntegrityVerifier;
import tech.kayys.andalus.knowledge.integrity.KnowledgeSnapshotIntegrityPolicy;
import tech.kayys.andalus.knowledge.seal.DefaultKnowledgeSnapshotSealCanonicalizer;
import tech.kayys.andalus.knowledge.seal.DefaultKnowledgeSnapshotSealVerificationService;
import tech.kayys.andalus.knowledge.seal.Ed25519KnowledgeSnapshotSignatureVerifier;
import tech.kayys.andalus.knowledge.snapshot.*;
import tech.kayys.andalus.knowledge.snapshot.dependency.InMemoryKnowledgeSnapshotDependencyGraph;
import tech.kayys.andalus.knowledge.snapshot.lifecycle.DefaultKnowledgeSnapshotRegistry;
import tech.kayys.andalus.knowledge.snapshot.lifecycle.InMemoryKnowledgeSnapshotRegistryStore;
import tech.kayys.andalus.knowledge.snapshot.lifecycle.KnowledgeSnapshotRetentionPolicy;
    ...
    void testCreateAndVerifyEvidencePackage() {
        ...
        DefaultKnowledgeSnapshotEvidencePackageVerifier verifier =
                new DefaultKnowledgeSnapshotEvidencePackageVerifier(
                        new tech.kayys.andalus.knowledge.integrity.DefaultKnowledgeSnapshotIntegrityService(
                                registry,
                                integrityVerifier
                        ),
