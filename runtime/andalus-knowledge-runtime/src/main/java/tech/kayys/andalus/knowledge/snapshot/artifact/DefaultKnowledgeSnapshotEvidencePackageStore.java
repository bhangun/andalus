package tech.kayys.andalus.knowledge.snapshot.artifact;

import tech.kayys.andalus.knowledge.snapshot.pack.KnowledgeSnapshotEvidencePackage;
...
public final class DefaultKnowledgeSnapshotEvidencePackageStore
    ...
    public KnowledgeSnapshotEvidencePackageArtifact put(
        ...
        KnowledgeEvidenceArtifactPutResult result = artifactService.put(
                serialized,
                "application/vnd.andalus.evidence-package+json",
                "andalus",
                "1"
        );
