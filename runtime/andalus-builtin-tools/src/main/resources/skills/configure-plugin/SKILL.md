...
```xml
<dependency>
  <groupId>tech.kayys.andalus.inference</groupId>
...
import tech.kayys.andalus.inference.plugin.spi.InferencePlugin;
import tech.kayys.andalus.inference.api.ProviderRequest;
...
```java
// Add to META-INF/services/tech.kayys.andalus.inference.plugin.spi.InferencePlugin
